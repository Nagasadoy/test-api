...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^(?=.*[a-zа-я])(?=.*[A-ZА-Я])(?=.*\d)[a-zа-яA-ZА-Я\d]{8,}$/, { message: 'Пароль должен содержать как минимум одну цифру, одну заглавную и одну строчную буквы.' }),
